...
const initApp = () => {
  ...
  $create.addEventListener('submit', e => {
    ...
    .then(() => {
      $createResult.innerHTML = `New user ${name} was successsfully created!`;
    })
    .catch((() => {
  ...
  $read.addEventListener('submit', e => {
    ...
    .catch(() => {
      $readResult.innerHTML = `Oops... there was an error while trying to read a user $${id}...`;
    });
  })
  ...
  $edit.addEventListener('submit', e => {
    ...
    const name = e.target.elements[1].value;
     ...
     .catch(() => {
      $editResult.innerHTML = `Oops... there was an error while trying to update user $${id}...`;
     });
  });
  ...
  $delete.addEventListener('submit', e => {
    ...
    const id = e.target.elements[0].value;
     ...
     .catch(() => {
      $deleteResult.innerHTML = `Oops... there was an error while trying to delete user $${id}...`;
     });
  });
};
